function TrailSection({section, sectionEditMode}){
    ...
    <tr>
        ...
        <td>{sectionEditMode === true ? <button className="btn btn-primary btn btn-sm mr-2" >Edit</button>
            : null}
            {sectionEditMode === true ? <button className="btn btn-primary btn btn-sm">Delete</button>
             : null}
        </td>
    </tr>
    </>)
